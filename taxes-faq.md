...
Например, для Bunq: симку вставляем в телефон, заходим в местный интернет (wifi или сотовый, важно, чтобы IP-адрес был из Нидерландов, и геолокация телефона это показывала) и ставим приложение Bunq.
